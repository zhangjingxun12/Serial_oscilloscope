...
void EMyThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<EMyThread *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (EMyThread::*)(QByteArray );
...
QT_INIT_METAOBJECT const QMetaObject EMyThread::staticMetaObject = { {
    &QThread::staticMetaObject,
    qt_meta_stringdata_EMyThread.data,
    qt_meta_data_EMyThread,
    qt_static_metacall,
    nullptr,
    nullptr
} };
